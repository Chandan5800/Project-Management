...
const Reducer = (state = initialState, action) => {
  switch (action.type) {
    ...
    case actionTypes.RECEIVE_MESSAGE: // WebSocket real-time messages
    // console.log("Reducer: Appending new message", action.message);
      return {
        ...state,
        messages: [...state.messages, action.message], // Append the received message
      };
